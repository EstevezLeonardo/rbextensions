...
/**
 * Endpoint POST que atualiza um produto existente (tabela
 * `produtos`). Usado quando a pessoa clica em "Editar" num item da
 * lista de resultados de dashboard/controle-produtos.php. Recebe
 * JSON: { id, codigo, nome, descricao, categoria, preco, quantidade,
 * ativo, csrf_token }.
 *
...
if (Produto::codigoExiste($dados['codigo'], $id)) {
    http_response_code(422);
