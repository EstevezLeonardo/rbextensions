...
/**
 * Endpoint POST que exclui um evento (tabela `eventos`). Usado pelo
 * botão "Excluir" de cada item da lista de resultados da busca (ver
 * dashboard/public/assets/js/agenda.js). Recebe JSON:
 * { id, csrf_token }.
 *
