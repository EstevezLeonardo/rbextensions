...
function ligarEdicaoDeDados(): void {
    ...
    botaoEditar.addEventListener('click', function () {
        form.querySelectorAll<HTMLInputElement | HTMLButtonElement>('.campo-editavel').forEach(function (campo) {
...
function ligarBotoesDeFoto(): void {
    ...
    const inputRemoverFoto = document.getElementById('input-remover-foto') as HTMLInputElement | null;
...
function atualizarBotaoRemoverFoto(botao: HTMLElement, marcadoParaRemover: boolean): void {
