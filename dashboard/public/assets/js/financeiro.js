...
(function () {
     ...
     */
    function ligarFiltro(recarregarTudo) {
    ...
    function parametrosDePeriodo(deEl, ateEl) {
     ...
     */
    function carregarResumo(deEl, ateEl) {
     ...
     */
    function carregarVendas(deEl, ateEl, pagina, irParaPagina, aoEstornar) {
     ...
     */
    function desenharVendas(vendas, corpoTabelaEl, mensagemEl, aoEstornar) {
        corpoTabelaEl.innerHTML = '';
        if (mensagemEl) {
     ...
     * lista.
     */
    function ligarBotaoEstornar(botao, venda, aoEstornar) {
        ...
        botao.addEventListener('click', function () {
            ...
            botao.disabled = true;
            const csrfToken = document.getElementById('financeiro-csrf-token').value;
