...
(function () {
    document.addEventListener('DOMContentLoaded', function () {
        const container = document.querySelector('nav .form-group .rows');
        const input = document.querySelector('nav .form-group input[name="search"]');
        const form = document.querySelector('nav .form-group');
    ...
    function buscarGlobal(termo, resultadosEl) {
    ...
    function desenharResultados(dados, resultadosEl) {
        ...
        if (dados.produtos.length > 0) {
            adicionarGrupoDeResultados(resultadosEl, 'Produtos', dados.produtos.map(function (produto) {
                return {
        ...
        if (dados.clientes.length > 0) {
            adicionarGrupoDeResultados(resultadosEl, 'Clientes', dados.clientes.map(function (cliente) {
                return {
        ...
        if (dados.vendas.length > 0) {
            adicionarGrupoDeResultados(resultadosEl, 'Vendas', dados.vendas.map(function (venda) {
    ...
    function adicionarGrupoDeResultados(resultadosEl, titulo, itens) {
