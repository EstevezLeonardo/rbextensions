...
(function () {
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const buscaTituloEl = document.getElementById('busca-titulo');
     ...
     */
    function ligarFormularioDeEvento(recarregarTudo) {
        ...
        const idEl = document.getElementById('evento-id');
        ...
        const preencherParaEdicao = function (evento) {
            ...
            document.getElementById('evento-fim').value = evento.end;
        ...
        form.addEventListener('submit', function (evento) {
            ...
            const csrfToken = document.getElementById('evento-csrf-token').value;
            const corpo = { titulo, inicio, fim, csrf_token: csrfToken };
            if (emEdicao) {
                corpo.id = idEl.value;
            }
            fetch(url, {
     ...
     */
    function ligarBuscaDeEventos(recarregarTudo) {
     ...
     */
    function carregarListaDeEventos(buscaTituloEl, buscaStatusEl, recarregarTudo) {
     ...
     */
    function desenharListaDeEventos(eventos, listaEl, mensagemEl, recarregarTudo) {
        listaEl.innerHTML = '';
        if (mensagemEl) {
     ...
     */
    function ligarBotaoExcluir(botao, evento, recarregarTudo) {
    ...
    function formatarPeriodo(inicioIso, fimIso) {
        const formatarData = function (iso) {
