...
(function () {
    document.addEventListener('DOMContentLoaded', function () {
        const buscaTextoEl = document.getElementById('busca-movimentacao-texto');
        const buscaTipoEl = document.getElementById('busca-movimentacao-tipo');
        const buscaCategoriaEl = document.getElementById('busca-movimentacao-categoria');
        let paginaAtual = 1;
     ...
     */
    function ligarFiltroDeCategoriaDoProduto() {
        const categoriaEl = document.getElementById('movimentacao-categoria-filtro');
        const produtoEl = document.getElementById('movimentacao-produto');
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const buscaTextoEl = document.getElementById('busca-compra-texto');
        const buscaDeEl = document.getElementById('busca-compra-de');
        const buscaAteEl = document.getElementById('busca-compra-ate');
        let paginaAtual = 1;
        const carregarPagina = function (pagina) {
            paginaAtual = pagina;
     ...
     */
    function ligarFormularioDeMovimentacao(aoRegistrar) {
        const form = document.getElementById('form-movimentacao');
        const mensagemEl = document.getElementById('movimentacao-mensagem');
        const produtoEl = document.getElementById('movimentacao-produto');
        const quantidadeEl = document.getElementById('movimentacao-quantidade');
        const observacaoEl = document.getElementById('movimentacao-observacao');
        const csrfEl = document.getElementById('movimentacao-csrf-token');
        ...
        form.addEventListener('submit', function (evento) {
            ...
            const radioTipoMarcado = document.querySelector('input[name="tipo"]:checked');
            const corpo = {
     ...
     */
    function ligarBuscaDeMovimentacoes(buscarDoInicio, categoriaEl) {
     ...
     */
    function carregarListaDeMovimentacoes(buscaTextoEl, buscaTipoEl, buscaCategoriaEl, pagina, irParaPagina, recarregarPaginaAtual) {
     ...
     */
    function desenharListaDeMovimentacoes(movimentacoes, listaEl, mensagemEl, recarregarPaginaAtual) {
        listaEl.innerHTML = '';
        if (mensagemEl) {
     ...
     * do histórico.
     */
    function ligarBotaoExcluir(botao, movimentacao, recarregarPaginaAtual) {
        ...
        botao.addEventListener('click', function () {
            ...
            botao.disabled = true;
            const csrfToken = document.getElementById('movimentacao-csrf-token').value;
    ...
    function formatarDetalhes(movimentacao) {
     ...
     */
    function ligarFormularioDeCompra(aoRegistrar) {
        const form = document.getElementById('form-compra');
        const mensagemEl = document.getElementById('compra-mensagem');
        const categoriaEl = document.getElementById('compra-categoria');
        const fornecedorEl = document.getElementById('compra-fornecedor');
        const dataEl = document.getElementById('compra-data');
        const valorEl = document.getElementById('compra-valor');
        const parcelasEl = document.getElementById('compra-parcelas');
        const csrfEl = document.getElementById('compra-csrf-token');
     ...
     */
    function ligarBuscaDeCompras(buscarDoInicio) {
     ...
     */
    function carregarListaDeCompras(buscaTextoEl, buscaDeEl, buscaAteEl, pagina, irParaPagina, recarregarPaginaAtual) {
     ...
     */
    function desenharListaDeCompras(compras, listaEl, mensagemEl, recarregarPaginaAtual) {
        listaEl.innerHTML = '';
        if (mensagemEl) {
     ...
     * uma página.
     */
    function desenharPaginacaoCompras(paginaAtual, totalPaginas, irParaPagina) {
     ...
     */
    function ligarBotaoExcluirCompra(botao, compra, recarregarPaginaAtual) {
        let confirmando = false;
        let timeoutId;
        botao.addEventListener('click', function () {
            if (!confirmando) {
            ...
            window.clearTimeout(timeoutId);
            botao.disabled = true;
            const csrfToken = document.getElementById('compra-csrf-token').value;
     ...
     */
    function formatarDetalhesCompra(compra) {
